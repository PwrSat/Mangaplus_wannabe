...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('creators.min.css') }}">
    <link rel="stylesheet" href="{{ asset('module.min.css') }}">
    <link rel="stylesheet" href="{{ asset('modal.min.css') }}">
    <link rel="stylesheet" href="{{ asset('mpc.css') }}">
