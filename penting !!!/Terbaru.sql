...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2023 at 11:39 PM
...
(1, 1, 1, 'Chapter 1', '2023-06-01 05:44:41', '2023-05-22 13:53:23'),
(2, 2, 1, 'Chapter 1', '2023-06-01 05:44:44', '2023-05-05 15:16:27'),
(3, 1, 2, 'Chapter 2', '2023-06-01 05:44:46', '2023-05-23 03:41:16'),
(4, 3, 1, 'Chapter 1', '2023-06-01 06:00:05', '2023-06-01 06:00:05'),
(5, 6, 1, 'Chapter 1', '2023-06-01 10:25:59', '2023-06-01 10:25:59');
...
INSERT INTO `comments` (`id`, `user`, `chapter`, `comment_text`, `comment_date`) VALUES
(1, 12, 1, 'satria ganteng', 0),
(2, 13, 1, 'satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng satria ganteng', 0),
(7, 12, 3, 'satria satria satria', 0),
(8, 12, 3, 'satria ganteng satria ganteng satria ganteng satria ganteng', 0);
...
(6, 'Takane to Hana', 'bercerita tentang Hana Nonomura yang diperankan oleh Aisa Takeuchi telah berusia 16 tahun. kakak perempuannya Yukari. mendapatkan perintah untuk melakukan kencan buta, tetapi Yukari tidak mau menghadiri kencan buta itu untuk mencari pasangan hidup.', 'YUKI SHIWASU', 'Tcover.jpg', '', 'inggris', 'jump', 1, NULL, NULL),
(7, 'One Punch Man', 'bermula dari pemuda bernama Saitama yang memiliki hobi unik sedari kecil yaitu menjadi seorang pahlawan. Untuk mewujudkan impiannya itu Saitama berupaya keras dengan terus berlatih serta berguru tanpa henti selama tiga tahun.', 'MURATA', 'Opcover.jpg', '', 'inggris', 'jump', 2, NULL, NULL),
...
INSERT INTO `users` (`id`, `username`, `email`, `user_role`, `email_verified_at`, `password`, `created_at`, `updated_at`) VALUES
(1, 'Dr. Diana Keeling Sr.', 'jerrell.macejkovic@hotmail.com', 'author', '1995-03-13 18:40:10', '}j\\6\\Q', NULL, NULL),
(2, 'Candida Bayer', 'ydaniel@johns.org', 'admin', '2007-01-23 20:34:34', 'i,ZU1>^RjR0F7*', NULL, NULL),
(3, 'Mrs. Alison Ledner PhD', 'pansy.okon@carroll.com', 'author', '2019-03-23 21:01:30', '^a9aQfVl~+2t21+D\'a8', NULL, NULL),
(4, 'Hadley Thiel Jr.', 'hlowe@yahoo.com', 'admin', '2016-11-27 08:48:45', ']@J%nJ5meerH.j,396m}', NULL, NULL),
(5, 'Marion Kris', 'vanessa79@schaefer.org', 'admin', '1970-12-24 21:51:56', ',:yK=pvhQq8tArLETU\\x', NULL, NULL),
(6, 'Dr. Dawson D\'Amore Jr.', 'obailey@yahoo.com', 'author', '2019-08-25 20:30:08', 'I=iF^98(kZcL%,Z%', NULL, NULL),
(7, 'Tyler Robel', 'jones.maye@yahoo.com', 'author', '2013-09-28 17:06:37', '<Z`KjU>$T*_Ujt', NULL, NULL),
(8, 'Josianne Tillman', 'qsteuber@stracke.com', 'author', '1988-12-01 22:37:47', 'R~;9eH5C6\'&WKh', NULL, NULL),
(9, 'Rocio Renner', 'kmayert@wolff.com', 'author', '2021-12-15 07:43:45', 'lxzTNS)&y$y', NULL, NULL),
(10, 'Verna Dooley DVM', 'reyes34@parker.biz', 'author', '1994-01-29 22:02:03', '0gs-yOWR{E)`+yd', NULL, NULL),
(11, 'harum', 'lulang@gmail.com', 'admin', NULL, 'halodunia', NULL, NULL),
(12, 'ZeeroXc', 'lk@gmail.com', 'admin', NULL, '12345678', NULL, NULL),
(13, 'van', 'sat@gmail.com', 'admin', NULL, '12345678', NULL, NULL);
